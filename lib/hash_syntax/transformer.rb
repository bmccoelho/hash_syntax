module HashSyntax
  module Transformer
    ...
    def self.transform(input_text, options)
      ...
      if options[:"to-18"]
        ...
        fail ArgumentError.new('Either :to-18 or :to-19 must be specified.')
      end
    end
    ...
    def self.transform_to_18(input_text, tokens, _options)
    ...
    def self.transform_to_19(input_text, tokens, _options)
      lines = input_text.lines.to_a # eagerly expand lines
